...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            #To get the best model name from report dict:
            ...
            logging.info(f"Found the best model for both Training and Test Dataset.")
            ...
            pred_r2_score = r2_score(y_test, predicted)
